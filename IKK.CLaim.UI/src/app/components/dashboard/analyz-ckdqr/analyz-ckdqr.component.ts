...
@Component({
  selector: 'app-analyz-ckdqr',
  templateUrl: './analyz-ckdqr.component.html',
  styleUrls: ['./analyz-ckdqr.component.css']
})
export class AnalyzCKDQRComponent implements OnInit {
  Analyzckdqrform!:FormGroup;
